...
pub mod arg_names {
    ...
    pub const UPDATE_CONFIG_ARG: &str = "update-config";
...
mod help_text {
    ...
    pub const ADD_UPDATE_CONFIG: &str = "Set the Steam or Lutris compatibility tool version after successfully adding\
     it.";
    // List
...
fn update_config_arg(help_text: &'static str) -> Arg {
    Arg::new(arg_names::UPDATE_CONFIG_ARG)
        .long(arg_names::UPDATE_CONFIG_ARG)
        .help(help_text)
}
...
fn setup_add_cmd() -> Command<'static> {
    Command::new(commands::ADD)
        ...
        .args(&[
            ...
            update_config_arg(help_text::ADD_UPDATE_CONFIG),
        ])
